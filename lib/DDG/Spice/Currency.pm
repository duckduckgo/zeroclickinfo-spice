...
my $keyword_qr = qr/(?:\s?(?<currencyKeyword>(?:((currency|value|price)(\sconversion|\sconverter|\scalculator)?)|(conversion|converter|calculator)|(exchange|conversion)\srate)|(value|price)\s?of)\s?)/i;
