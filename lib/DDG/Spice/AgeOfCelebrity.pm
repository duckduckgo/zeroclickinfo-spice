...
spice to => 'https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|info|pageimages&inprop=url&exintro=&explaintext=&titles=$1&continue=&redirects';
