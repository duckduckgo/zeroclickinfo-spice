...
spice from => '([^/]+)/?(?:([^/]+)/?(?:([^/]+)|)|)';
spice to => 'https://api.quixey.com/1.0/search?partner_id=2073823582&partner_secret={{ENV{DDG_SPICE_QUIXEY_TESTING_APIKEY}}}&q=$1&platform_ids=$2&custom_id=$3&limit=30&skip=0&format=json&callback={{callback}}';
