package DDG::Spice::ESPN::PGA;

use DDG::Spice;
use Time::localtime;

description "News and stats for PGA players";
name "ESPN PGA";
primary_example_queries "Tiger Woods", "Jeff Maggert";
topics "entertainment", "special_interest";
category "reference";
code_url "https://github.com/duckduckgo/zeroclickinfo-spice/blob/master/lib/DDG/Spice/ESPN/PGA.pm";
...
spice to => 'http://api.espn.com/v1/sports/golf/pga/$1/$2/$3'
