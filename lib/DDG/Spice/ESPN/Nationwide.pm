package DDG::Spice::ESPN::Nationwide;

use DDG::Spice;
use Time::localtime;

description "News and stats for Nationwide players";
name "ESPN Nationwide";
primary_example_queries "Kyle Busch", "Brad Keselowski";
topics "entertainment", "special_interest";
category "reference";
code_url "https://github.com/duckduckgo/zeroclickinfo-spice/blob/master/lib/DDG/Spice/ESPN/Nationwide.pm";
...
spice to => 'http://api.espn.com/v1/sports/racing/nationwide/$1/$2/$3'
