...
code_url 'https://github.com/duckduckgo/zeroclickinfo-spice/blob/master/lib/DDG/Spice/Indego/IndegoBikeshareLocations.pm';
attribution github => 'AcriCAA',
            web  => ['http://www.coreyacri.com',  'Corey Acri'];

triggers any => 'philly bikeshare', 'indego philadelphia', 'bikeshare', 'bike share';
