...
code_url "https://github.com/bryanhart/zeroclickinfo-spice/blob/master/lib/DDG/Spice/RiffsyGifSearch.pm";
attribution web => ["http://www.riffsy.com","Riffsy"],
            twitter => "riffsyapp";


spice to => 'http://api1.riffsy.com/v1/search?tag=$1&key={{ENV{DDG_SPICE_RIFFSY_APIKEY}}}&safesearch=strict';
