...
spice post_body => '{"_source":"module","fields":["documentation","author","abstract.analyzed","release","path","status","indexed","authorized","distribution","date","id","pod_lines"],"query":{"filtered":{"filter":{"and":[{"not":{"filter":{"or":[{"term":{"distribution":"kurila"}},{"term":{"distribution":"perl_debug"}},{"term":{"distribution":"perl_mlb"}},{"term":{"distribution":"perl-5.005_02+apache1.3.3+modperl"}},{"term":{"distribution":"pod2texi"}},{"term":{"distribution":"perlbench"}},{"term":{"distribution":"spodcxx"}},{"term":{"distribution":"Bundle-Everything"}}]}}},{"term":{"status":"latest"}},{"term":{"authorized":1}},{"term":{"indexed":1}},{"or":[{"and":[{"exists":{"field":"module.name"}},{"term":{"module.indexed":1}}]},{"exists":{"field":"documentation"}}]}]},"query":{"function_score":{"query":{"boosting":{"negative_boost":0.5,"positive":{"bool":{"should":[{"term":{"documentation":{"boost":100,"value":"$1"}}},{"term":{"module.name":{"boost":100,"value":"$1"}}},{"dis_max":{"queries":[{"query_string":{"fields":["documentation.analyzed^2","module.name.analyzed^2","distribution.analyzed","documentation.camelcase","module.name.camelcase","distribution.camelcase"],"boost":3,"query":"$2","allow_leading_wildcard":0,"default_operator":"AND","use_dis_max":1}},{"query_string":{"fields":["abstract.analyzed","pod.analyzed"],"query":"$1","allow_leading_wildcard":0,"default_operator":"AND","use_dis_max":1}}]}}]}},"negative":{"term":{"mime":{"value":"text/x-script.perl"}}}}},"metacpan_script":"prefer_shorter_module_names_400"}}}}}';
