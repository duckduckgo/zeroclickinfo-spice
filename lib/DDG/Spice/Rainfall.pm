...
#spice to => '"http://climatedataapi.worldbank.org/climateweb/rest/v1/country/annualavg/cccma_cgcm3_1/pr/1980/1999/$1.json?callback={{callback}}"';

spice to => 'http://api.worldbank.org/countries/$1/indicators/AG.LND.PRCP.MM?&date=2012:2012&format=json';
