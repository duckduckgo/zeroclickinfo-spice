...
ddg_spice_ddg_traffic_stats.fetch_graph_data = function() {
  ...
  $.getJSON('http://whateverorigin.org/get?url=' + encodeURIComponent('https://duckduckgo.com/traffic_data/direct.csv') + '&callback=?',
    function(data) {
...
ddg_spice_ddg_traffic_stats.render_graph = function(graph_data) {
  ...
  $.getScript('https://duckduckgo.com/traffic_data/dygraph-combined.js', graph_data, function() {
    var g_annotations = [
      {
        series: "Queries",
        x: "20110103",
    ...
    var roll_period = 28;
    var g = new Dygraph(document.getElementById('ddg_traffic_stats_graph'), graph_data, {
