!function(env) {
    ...
    env.ddg_spice_bootic = function(api_result) {
        ...
        var query = api_result.input_query ? "?initial=1&q=" + encodeURIComponent(api_result.input_query) : "";
        ...
        Spice.add({
            ...
            normalize: function(o) {
                ...
                return picture.replace(/_pictures\/\d+x\d+/, "_pictures/200x300"), picture = "http://static.bootic.com/_pictures/" + picture, 
                {
                    parentId: o.id,
