define("ace/mode/javascript", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/javascript_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/worker/worker_client", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle" ], function(e, t, n) {
    ...
    r.inherits(h, i), function() {
        this.lineCommentStart = "//", this.blockComment = {
            ...
            var s = i.tokens;
            var o = i.state;
            if (s.length && "comment" == s[s.length - 1].type) {
                return r;
            }
    ...
    var m = function() {
        m.isSaneInsertion = function(e, t) {
            ...
            if (!this.isAutoInsertedClosing(r, i, c[0])) {
                f = 0;
            }
            ...
            var r = e.getCursorPosition();
            var i = t.doc.getLine(r.row);
            if (!this.isMaybeInsertedClosing(r, i)) {
                h = 0;
            }
            p = r.row, d = i.substr(0, r.column) + n, v = i.substr(r.column), h++;
            ...
            if ("{" == i) {
                ...
                if ("" !== f && "{" !== f && n.getWrapBehavioursEnabled()) {
                    ...
                    if (m.isSaneInsertion(n, r)) {
                        if (/[\]\}\)]/.test(u[s.column])) {
                            ...
                            return m.recordMaybeInsert(n, r, "{"), {
                                text: "{",
                                selection: [ 1, 1 ]
                            };
                        }
                ...
                if ("}" == i) {
                    ...
                    if ("}" == l) {
                        ...
                        if (null !== c && m.isAutoInsertedClosing(s, u, i)) {
            ...
            if ("(" == i) {
                ...
                if (")" == i) {
                    ...
                    if (")" == f) {
                        ...
                        if (null !== l && m.isAutoInsertedClosing(u, a, i)) {
                            return m.popAutoInsertedClosing(), {
                                text: "",
                                selection: [ 1, 1 ]
                            };
            ...
            if ('"' == i || "'" == i) {
                ...
                if ("" !== u && "'" !== u && '"' != u && n.getWrapBehavioursEnabled()) {
                    ...
                    if (!p || 0 > d && "comment" !== p.type && ("string" !== p.type || o.start.column !== p.value.length + h - 1 && p.value.lastIndexOf(s) === p.value.length - 1)) {
                        if (!m.isSaneInsertion(n, r)) {
                            return;
                        }
                        return {
    ...
    r.inherits(o, s), function() {
        ...
        this.getFoldWidgetRange = function(e, t, n) {
            ...
            if (i) {
                var s = i.index;
                if (i[1]) {
                    return this.openingBracketBlock(e, i[1], n, s);
                }
            ...
            if (i) {
                ...
                if (i[1]) {
                    return this.closingBracketBlock(e, i[1], n, s);
                }
