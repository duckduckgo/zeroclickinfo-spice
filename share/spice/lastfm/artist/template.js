...
function program3(depth0,data) {
  ...
  buffer += "<div>\n    ";
  stack2 = helpers['if'].call(depth0, ((stack1 = ((stack1 = depth0.artist),stack1 == null || stack1 === false ? stack1 : stack1.bio)),stack1 == null || stack1 === false ? stack1 : stack1.summary), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
...
templates['similar'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
