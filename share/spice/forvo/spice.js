function ddg_spice_forvo(data) {
    if (data.attributes.items != "0") {
        ...
        for (var i = 0; i < 3 && i < words.length; i++){
            ...
            p.innerHTML = "Pronunciation for: " + word.original;
            ...
            YAHOO.util.Dom.setStyle(div, "margin-bottom", "8px");
            YAHOO.util.Dom.setStyle(div, "width", "100%");
            YAHOO.util.Dom.setStyle(div, "height", "35px");
            YAHOO.util.Dom.setStyle(div, "clear", "both");

            YAHOO.util.Dom.setStyle(audio, "display", "block");
            YAHOO.util.Dom.setStyle(audio, "float", "left");
            YAHOO.util.Dom.setStyle(audio, "width", "250px");
            
            YAHOO.util.Dom.setStyle(p_div, "width", "320px");
            YAHOO.util.Dom.setStyle(p_div, "height", "25px");
            YAHOO.util.Dom.setStyle(p_div, "display", "block");
            YAHOO.util.Dom.setStyle(p_div, "float", "left");
            YAHOO.util.Dom.setStyle(p_div, "padding-top", "5px");
