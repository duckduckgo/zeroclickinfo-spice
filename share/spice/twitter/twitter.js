var ddg_spice_twitter = function(api_result) {
    ...
    var infobox = api_result.current_status ? Spice.twitter.infobox : !1;
...
Handlebars.registerHelper("twitter_findLinks", function(text, entities, options) {
    ...
    var twitterSplit = function(twitter, result, final_text, original, start_index, i) {
        if (twitter.length === i || 0 === twitter.length) {
            return result.push({
                text: final_text
            }), result;
        } else {
            ...
            return result.push({
                ...
                link: twitter[i]
            }), start_index = indices[1], twitterSplit(twitter, result, original.substring(start_index, original.length), original, start_index, i + 1);
        }
    };
    ...
    return all_entities.sort(function(a, b) {
        ...
        return 0;
    }), options.fn(twitterSplit(all_entities, [], text, text, 0, 0));
